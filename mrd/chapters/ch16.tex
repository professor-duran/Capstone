...
\item \textbf{Mileage}: reimbursed at the current IRS standard mileage rate (check \texttt{irs.gov} for the current year's rate; \$0.70/mile for 2025). Calculate from 1500 Illinois St., Golden CO 80401. Save the Google Maps route as PDF. \textbf{Gas not reimbursable} for personal vehicles.
