...
The Ethics Assignment (SDI Sprint~4) is a \textbf{750--1500 word argumentative essay}; not an informative report, not a book summary, and not a list of ethical principles. You must:
...
Capstone reports use IEEE citation format~[24]. Key conventions:
