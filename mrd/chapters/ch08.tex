...
PDR is your first opportunity to receive formal, structured feedback from the PA, client, and TAs on the entirety of your engineering approach. Teams that treat PDR as a checkbox exercise produce weak designs; teams that use PDR as a genuine review emerge with stronger designs and clearer paths forward.
...
\item Complete SDRD with IDs, SHALL/SHOULD, rationale, traceability, TAID, MoSCoW
...
\item Concept selection: Pugh screening + weighted decision matrix + sensitivity analysis
...
Requirements & Key performance requirements, constraints, MoSCoW & 3--4 min \\
Concepts \& Selection & Concepts considered, decision matrix, sensitivity & 5--7 min \\
Architecture & Block diagram, interfaces, critical subsystems & 3--5 min \\
Risk \& Feasibility & Top risks, mitigations, PoC results & 2--3 min \\
Plan Forward & Schedule through SDII, procurement timeline & 2--3 min \\
...
\textbf{Show the divergent thinking}: present all concepts generated, not just the final three. A slide showing ``we generated 15 concepts using brainstorming, SCAMPER, and morphological chart analysis, then screened to 3 using Pugh matrix'' demonstrates creative rigor. Show the morphological chart or the brainstorming results briefly.
