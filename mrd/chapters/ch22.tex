...
The NCEES Model Rules~[20] define the ethical obligations of licensed engineers. These rules apply to you as aspiring professionals, even before licensure. The key principles are summarized below; this is not the complete text of the Model Rules. While this summary captures the spirit of the rules, the specific wording and scope of obligations can change with periodic NCEES updates. The current, complete NCEES \textit{Model Rules of Professional Conduct} are available at \url{https://ncees.org/licensure/laws-and-rules/} and are the authoritative source.
...
The Ethics Assignment (SDI, Sprint~4) is a \textbf{750--1500 word argumentative essay}. You must take a controversial stance on an ethical issue directly connected to your project's hardware, software, or system, defend it with evidence, and address opposing viewpoints. See Chapter~5 for essay structure and Chapter~18 for writing guidance.
