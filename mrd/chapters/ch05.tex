...
\item \textbf{Construction materials and infrastructure}: the materials phase dominates embodied energy and carbon. Concrete produces $\sim$0.13\,kg CO$_2$/kg; steel produces $\sim$1.8\,kg CO$_2$/kg; aluminum produces $\sim$8.1\,kg CO$_2$/kg (values from the ICE Database; verify against current data for your materials). Focus on material selection and material reduction.
