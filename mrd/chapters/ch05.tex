...
\textbf{Step 3: Estimate the dominant impact.} Use published data to estimate the primary environmental metric for your dominant phase. For energy consumption: estimate annual kWh and multiply by the local grid emission factor (Colorado: $\sim$0.6\,kg CO\textsubscript{2}/kWh). For material impact: estimate mass of each material and multiply by the embodied energy or CO\textsubscript{2} factor from published databases (e.g., Granta Edupack, ICE Database).
