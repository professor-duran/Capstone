...
Detailed enough that all parties agree on what ``done'' looks like for every deliverable. Include explicit ``Out of Scope'' items. Your Project Advisor (PA) evaluates the project against the SOW. See Course Text Ch.~7 for the complete SOW structure.
\end{faqbox}
