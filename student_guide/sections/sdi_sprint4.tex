...
\item Apply CLO~5 (sustainability/societal impact) sustainability tool (LEED, ENVISION, DFE, or ESJ). See Course Text Ch.~5, Table ``Choosing the Right CLO~5 Tool'' for guidance on which tool fits your project.
\item Complete the FDVSE value assessment (Feasibility, Desirability, Viability, Sustainability, Ethical Responsibility). See Course Text Ch.~5, Section~5.2 for the framework and guiding questions.
...
\item Ethics Assignment (750--1500 word argumentative essay)
