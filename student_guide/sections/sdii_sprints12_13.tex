...
\begin{faqbox}[Track-Specific Final Preparation]
\textbf{Paper Track:} Spend at least 30\% of remaining time on verification and validation, not running more simulations. Document all assumptions. Create a user guide for reproducibility.

\textbf{Competition Track:} Finalize logistics (vehicle, hotel, equipment shipping). Conduct practice runs and dry rehearsals. Remember: FDR evaluates your engineering process, not your competition placement.
\end{faqbox}
...
\item Design-Build-Test-Redesign Slide (a single slide summarizing key iterations: what was designed, built, tested, and redesigned throughout the project)
\end{itemize}
