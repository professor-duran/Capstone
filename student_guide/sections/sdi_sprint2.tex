...
\begin{faqbox}[Track-Specific Requirements Guidance]
\textbf{Paper Track:} Include quantitative analytical targets (convergence criteria, accuracy thresholds, validation benchmarks). ``Develop a model'' is not a requirement; ``Achieve mesh-independent results within 5\% of published experimental data'' is.

\textbf{Competition Track:} Map every competition rule to an engineering requirement with quantitative acceptance criteria. Safety rules = MUST HAVE. Scoring criteria = SHOULD HAVE.
\end{faqbox}
