...
\begin{faqbox}[Are we just building what the client tells us to?]
No. Think of your team as a \textbf{contracted design firm}, not an order-taking service. The client provides the need; you provide the engineering expertise and technical direction. When information is incomplete, make assumptions, document them, and validate with the client. If the client knew exactly what to build and how, they would not need engineers. Lead the design, bring recommendations (not open-ended questions) to client meetings, and iterate when you learn something new. See \textbf{Chapter~1} of the Course Text for the full discussion of this philosophy.
\end{faqbox}
