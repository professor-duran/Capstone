...
\fancyhead[R]{\textcolor{minesblue}{AY 2025--2026}}
\fancyfoot[C]{\thepage}
...
\textbf{A note on numbering}: section numbers in this Student Guide (e.g., ``Section~3'') refer to sections \emph{within this guide}, not to chapters in the Course Text. When referencing the Course Text, this guide always uses the format ``Course Text Ch.~X'' to avoid confusion.
...
\input{sections/assignments_rubrics}
